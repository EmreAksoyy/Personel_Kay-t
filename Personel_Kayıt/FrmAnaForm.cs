...
namespace Personel_Kayıt
{
    public partial class FrmAnaForm : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source = DESKTOP-T5I9GB3\\SQLEXPRESS; Initial Catalog = PersonelVeriTabani; Integrated Security = True; Encrypt=False");
        void temizle() {
            Txtid.Text = "";
            TxtAd.Text = "";
            TxtSoyad.Text = "";
